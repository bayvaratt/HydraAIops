...
\addlinespace
CNN-LSTM extension & Partial & Implemented but convergence failed (Section~\ref{sec:cnnlstm-results}) \\
\addlinespace
GNN extension & Partial & Fully implemented; limited to TON\_IoT (requires IP columns) \\
\bottomrule
\end{tabular}
\end{table}
